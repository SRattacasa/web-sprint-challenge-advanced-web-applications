...
A unique identifier generated by the backend to help authenticate future connections. It is stored locally in our implementation, and then pushed with future requests to validate the client.

2. What steps can you take in your web apps to keep your data secure?

App firewall, segment out the database backend, leverage salting and hashing of the credentials, consider levearging a third party API for AAA (like Okta), never share backend code with the front end and never put things that shouldn't be client accessible on the front end.

3. Describe how web servers work.

They take inbound HTTP requests and based on the type of request, act upon the data shared, respond in kind, and the client browser is updated based on the information shared. THis happens over TCP/IP, and DNS is generally used to translate hostnames/web address into IP addresses (usually of a firewall, proxy, CDN, etc.)
